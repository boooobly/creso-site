...
const defaultSiteImageAssets = [
  ...
  { title: 'Плоттерная резка — главный экран', scope: 'site', fileName: 'plotter.hero.main', url: '/images/plotter/plotter_hero.png', altText: 'Плоттерная резка самоклеящейся пленки', mimeType: 'image/png', isActive: true, sortOrder: 90 },
  { title: 'Плоттерная резка — пример: стикерпак', scope: 'site', fileName: 'plotter.examples.labels', url: '/images/plotter/plotter_labels.png', altText: 'Стикерпак для бренда', mimeType: 'image/png', isActive: true, sortOrder: 100 },
  { title: 'Плоттерная резка — пример: витрина', scope: 'site', fileName: 'plotter.examples.window', url: '/images/plotter/plotter_window.png', altText: 'Оформление витрины', mimeType: 'image/png', isActive: true, sortOrder: 110 },
  { title: 'Плоттерная резка — пример: резка по меткам', scope: 'site', fileName: 'plotter.examples.stickers', url: '/images/plotter/plotter_stickers.png', altText: 'Резка по меткам', mimeType: 'image/png', isActive: true, sortOrder: 120 },
  { title: 'Плоттерная резка — пример: оклейка машины', scope: 'site', fileName: 'plotter.examples.car', url: '/images/plotter/plotter_car.png', altText: 'Оклейка машины', mimeType: 'image/png', isActive: true, sortOrder: 130 },
  ...
  { title: 'Печать на футболках — главный экран', scope: 'site', fileName: 'tshirts.hero.main', url: '/images/t-shirt/termoplenka.png', altText: 'Печать на футболках — крупный план нанесения', mimeType: 'image/png', isActive: true, sortOrder: 131 },
