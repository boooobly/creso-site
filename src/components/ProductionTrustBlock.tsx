  ...
  return (
    <section className="bg-neutral-50/70 py-12 md:py-20">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <RevealOnScroll className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm md:p-7 lg:p-8">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
              {productionPlaceholders.map((item) => (
                ...
                >
                  ...
                  <div className="relative mt-3 min-h-[190px] overflow-hidden rounded-lg md:min-h-[220px]">
                    <Image
                      src={item.imageSrc}
                      alt={item.imageAlt}
                      fill
