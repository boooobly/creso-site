  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      {showMessageField ? (
        ...
        <p className="t-muted text-neutral-600 dark:text-neutral-300">Укажите телефон или e-mail — как вам удобнее.</p>
      )}
      <p className="t-muted text-neutral-600 dark:text-neutral-300">Ответим в течение 30 минут. Без спама.</p>
