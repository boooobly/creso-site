...
export default function LeadForm({
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <p className="t-small rounded-xl border border-neutral-200/85 bg-gradient-to-b from-white to-neutral-50/80 px-3.5 py-2.5 text-muted-foreground">Ответим в течение 30 минут. Без спама.</p>

      <label className="flex items-start gap-2.5 rounded-xl border border-neutral-200/85 bg-white px-3.5 py-2.5 text-sm font-medium">
