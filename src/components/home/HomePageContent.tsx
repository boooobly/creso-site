  ...
  return (
    <div className="relative">
      <Section spacing="hero" fullBleed className="relative overflow-hidden border-b border-neutral-200/70 dark:border-neutral-800/80">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 top-0 h-56 bg-gradient-to-b from-red-50/40 to-transparent dark:from-[rgba(212,28,28,0.24)] dark:via-[rgba(92,22,22,0.14)] dark:to-transparent"
        />
