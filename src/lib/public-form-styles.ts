export const publicFormStyles = {
  shell: 'card rounded-3xl border-neutral-200/90 bg-white/95 p-6 shadow-[0_18px_40px_-32px_rgba(15,23,42,0.52)] dark:border-neutral-800/90 dark:bg-neutral-900/95 md:p-8',
  ...
  inputBase:
    'h-11 w-full rounded-xl border border-neutral-300 bg-white px-4 text-sm text-neutral-900 shadow-sm transition-all duration-200 placeholder:text-neutral-400 hover:border-neutral-400 focus:border-[var(--brand-red)] focus:outline-none focus:ring-2 focus:ring-[var(--brand-red)]/25 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 dark:placeholder:text-neutral-500 dark:focus:ring-[var(--brand-red)]/30',
