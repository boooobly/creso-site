export const publicFormStyles = {
  ...
  uploadZone: 'rounded-xl border-2 border-dashed border-neutral-300 bg-neutral-50/55 p-3 transition-colors hover:border-red-400 dark:border-neutral-600/90 dark:bg-neutral-950/70 dark:hover:border-red-400/70 md:p-4',
  ...
  summaryCard: 'rounded-xl border border-neutral-200 bg-neutral-50/80 p-4 text-sm dark:border-neutral-700/80 dark:bg-neutral-950/72 dark:text-neutral-200',
