export const publicFormStyles = {
  ...
  uploadZone: 'rounded-xl border-2 border-dashed border-neutral-300 bg-neutral-50/55 p-3 transition-colors hover:border-red-400 dark:border-neutral-700/90 dark:bg-gradient-to-b dark:from-neutral-900/95 dark:to-neutral-950/92 dark:hover:border-red-400/70 md:p-4',
  ...
  summaryCard: 'rounded-xl border border-neutral-200 bg-neutral-50/80 p-4 text-sm dark:border-neutral-700/85 dark:bg-gradient-to-b dark:from-neutral-900/88 dark:to-neutral-950/88 dark:text-neutral-200',
