          ...
          <div className="grid gap-4 md:grid-cols-2">
            {equipment.map((item) => (
              <RevealOnScroll key={item.title}>
                <article className="group relative isolate min-h-[248px] overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-900 shadow-sm transition-[border-color,box-shadow] duration-200 hover:border-neutral-300 hover:shadow-md">
                  <div className="relative h-full w-full transition-transform duration-200 group-hover:-translate-y-0.5">
