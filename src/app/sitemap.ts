...
const PUBLIC_ROUTES: PublicSitemapRoute[] = [
  ...
  { route: '/advertising-signs', changeFrequency: 'weekly', priority: 0.9 },
  { route: '/banner-printing', changeFrequency: 'weekly', priority: 0.9 },
  { route: '/lightboxes', changeFrequency: 'weekly', priority: 0.88 },
  { route: '/volume-letters', changeFrequency: 'weekly', priority: 0.88 },
  ...
  { route: '/blog', changeFrequency: 'weekly', priority: 0.78 },
